  ...
  async function finishWorkout(roundsDone: number) {
    ...
    await app?.updateModelContext({
      content: [
        {
          type: "text",
          text: `The user has completed ${roundsDone} rounds of the workout ${JSON.stringify(
            workout
          )}`,
        },
      ],
  ...
  async function nextRound() {
    ...
    await app.updateModelContext({
      content: [
        {
          type: "text",
          text: `The user has completed ${currentRound} round of ${totalRounds} of the workout ${JSON.stringify(
            workout
          )}`,
        },
      ],
